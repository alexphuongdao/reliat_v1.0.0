...
| `v1.0.7` | Agent threads — logged in `2026-08-12-agent-demo.md` | 31 pass / 3 xfail |
| `v1.0.8` | Agent tab rebuilt — logged in `2026-08-12-agent-demo.md` | 31 pass / 3 xfail |
...
## v1.0.7 / v1.0.8 — agent threads and the Agent tab

Moved to **`logs/2026-08-12-agent-demo.md`** — the agent surface is its own
topic, not part of this defect sweep. That file covers the schema
(`agent_threads`, `agent_messages`), how the hypothesis percentages actually
work, the deleted cross-tenant canned reply, and the verification.
